        ...
        <div class="card-body">
            <form action="{{ route('admin.themes.config', $theme) }}" method="POST" id="configForm">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('home_title') is-invalid @enderror" id="titleInput" name="home_title" value="{{ old('home_title', theme_config('home_title')) }}">
                ...
                <div class="form-group">
                    <label for="titleInput">{{ trans('theme::prism.config.title') }}</label>
